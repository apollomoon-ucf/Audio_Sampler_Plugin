...
double VibeSamplerAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int VibeSamplerAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void VibeSamplerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void VibeSamplerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool VibeSamplerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void VibeSamplerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
void VibeSamplerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void VibeSamplerAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
